...
def prioritization_agent(this_task_id: int):
    ...
    prompt = f"""You are an task prioritisation AI tasked with cleaning the formatting of and reprioritising the following tasks: {task_names}. Consider the ultimate objective of your team:{OBJECTIVE}. Do not remove any tasks  and always use UK english in spelling & formatting of tasks. Return the result as a numbered list like:
    #. First task
    #. Second task
